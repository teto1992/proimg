...
from declace_simulation_framework.simulator.saboteurs import (InstanceSaboteur, ImageSizeWobble, NodeStorageWobble,
...
if __name__ == '__main__':
    g = NetworkGenerator(
        ...
        LinkGenerator(
            latency=UniformDiscrete(1, 2, 3, 4),
            bandwidth=UniformDiscrete(1, 2, 3, 4)
        )
    )
    ...
    images = [
        Image("ubuntu", 120, 8.0),
        Image("busybox", 150, 4.0)
    ]
